...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{checkout} & \camelcase{list<CollaborationResource>} & Performs the checkout operation. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & credentials & \camelcase{Credentials} & The credentials of the user in the underlying VCS. \\\hline 
	 & resources & \camelcase{list<CollaborationResourceReference>} & The references to the required resources. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
	 & \camelcase{VCSAuthenticationFailed} & \multicolumn{2}{p{8.5cm}|}{The client failed to prove its identity in the VCS.} \\\hline 
...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{commit} & \camelcase{void} & Performs the commit operation. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & credentials & \camelcase{Credentials} & The credentials of the user in the underlying VCS. \\\hline 
	 & resources & \camelcase{list<CollaborationResourceReference>} & The references to the required resources. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{pull} & \camelcase{list<CollaborationResource>} & Performs the pull operation. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & credentials & \camelcase{Credentials} & The credentials of the user in the underlying VCS. \\\hline 
	 & resources & \camelcase{list<CollaborationResourceReference>} & The references to the required resources. \\\hline 
...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{publishLockDefinition} & \camelcase{void} & Publishes a lock definition. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & credentials & \camelcase{Credentials} & The credentials of the user in the underlying VCS. \\\hline 
...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{unpublishLockDefinition} & \camelcase{void} & Unpublish a lock definition. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & credentials & \camelcase{Credentials} & The credentials of the user in the underlying VCS. \\\hline 
	 & specification & \camelcase{CollaborationLockQuerySpec} & The lock query specification. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{lock} & \camelcase{void} & Locks the pattern with the given bindings. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & credentials & \camelcase{Credentials} & The credentials of the user in the underlying VCS. \\\hline 
...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{unlock} & \camelcase{void} & Unlocks the pattern with the given bindings. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & credentials & \camelcase{Credentials} & The credentials of the user in the underlying VCS. \\\hline 
	 & specification & \camelcase{CollaborationQueryInvocationSpecification} & The lock specification with pattern and its bindings. \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure CollaborationGitResourceReference}
	\label{tab:collaborationGitResourceReference}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{branch}  & \camelcase{string}  & The name of the Git branch to which new commits should be pushed. \\\hline
		  \camelcase{commit}  & \camelcase{string}  & The SHA1 identifier of the commit with the resource. \\\hline
		  \camelcase{repositoryUri}  (\nohyphens{inherited}) & \camelcase{string}  & The URI of the repository containing the resource. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure CollaborationLockQuerySpec}
	\label{tab:collaborationLockQuerySpec}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{patternFQN}  & \camelcase{string}  & Fully qualified name of the pre-existing query. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure CollaborationQueryBinding}
	\label{tab:collaborationQueryBinding}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{name}  & \camelcase{string}  & Name of the query parameter being bound. \\\hline
		  \camelcase{value}  & \camelcase{string}  & Value to be bound to the query parameter. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure CollaborationQueryInvocationSpecification}
	\label{tab:collaborationQueryInvocationSpecification}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{bindings}  & \camelcase{list<CollaborationQueryBinding>}  & Name/value bindings to be provided to the query. \\\hline
		  \camelcase{patternFQN}  & \camelcase{string}  & Fully qualified name of the pre-existing query. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure CollaborationResource}
	\label{tab:collaborationResource}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{file}  & \camelcase{File}  & File with the contents of the resource. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure CollaborationResourceReference}
	\label{tab:collaborationResourceReference}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{repositoryUri}  & \camelcase{string}  & The URI of the repository containing the resource. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure CollaborationSvnResourceReference}
	\label{tab:collaborationSvnResourceReference}\\
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{filePath}  & \camelcase{string}  & The path to the resource within the SVN repository. \\\hline
		  \camelcase{repositoryUri}  (\nohyphens{inherited}) & \camelcase{string}  & The URI of the repository containing the resource. \\\hline
		  \camelcase{revision}  & \camelcase{string}  & The revision number containing the resource. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	\caption{Structure OperationModel}
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	...
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{resourceReference}  & \camelcase{CollaborationResourceReference}  & Reference to the locked resource. \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	...
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{resourceReference}  & \camelcase{CollaborationResourceReference}  & Reference to the missing resource. \\\hline
