...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\cline{2-4}%
	\multicolumn{1}{c|}{} & \textbf{Name} & \textbf{Type} & \textbf{Documentation} \\\hline 
	\textbf{Operation} & \camelcase{listPlugins} & \camelcase{list<string>} & Lists all the plugins that can be enabled: metamodel parsers, model parsers, query parsers, updaters and graph change listeners. \\\hline
	\textbf{Parameters} & \multicolumn{3}{l|}{None.} \\\hline
\end{longtable}
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
...
\begin{longtable} {|p{2cm}|p{3.5cm}|p{2.5cm}|p{6.5cm}|}
	...
	\textbf{Parameters} & \multicolumn{3}{l|}{} \\\hline
	 & goldRepoURL & \camelcase{string} &  \\\hline 
	\textbf{Exceptions} & \multicolumn{3}{l|}{} \\\hline
	 & \camelcase{GoldRepoNotFound} & \multicolumn{2}{p{8.5cm}|}{No gold repository is configured at the specified URL.} \\\hline 
	 & \camelcase{UnauthorizedRepositoryOperation} & \multicolumn{2}{p{8.5cm}|}{Authenticated user is not permitted to carry out the requested operation on the specified repository.} \\\hline 
	 & \camelcase{OfflineCollaborationInternalError} & \multicolumn{2}{p{8.5cm}|}{An internal error occurred on the collaboration server. See details in server log.} \\\hline 
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	...
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{slots}  & \camelcase{set<string>}  &  \\\hline
		  \camelcase{type}  & \camelcase{string}  &  \\\hline
...
\begin{longtable} {|p{4cm}|p{4cm}|p{7.25cm}|}
	...
	\hline%
	\textbf{Field} & \textbf{Type} & \textbf{Documentation} \\\hline
		  \camelcase{metamodel}  & \camelcase{map<string,set<string>>}  &  \\\hline
		  \camelcase{uri}  & \camelcase{string}  &  \\\hline
