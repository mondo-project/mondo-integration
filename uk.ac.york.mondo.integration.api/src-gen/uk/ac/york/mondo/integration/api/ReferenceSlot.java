            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.positions = new ArrayList<Integer>(_list64.size);
                int _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = iprot.readI32();
                  struct.positions.add(_elem65);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new ArrayList<String>(_list67.size);
                String _elem68;
                for (int _i69 = 0; _i69 < _list67.size; ++_i69)
                {
                  _elem68 = iprot.readString();
                  struct.ids.add(_elem68);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.mixed = new ArrayList<MixedReference>(_list70.size);
                MixedReference _elem71;
                for (int _i72 = 0; _i72 < _list70.size; ++_i72)
                {
                  _elem71 = new MixedReference();
                  _elem71.read(iprot);
                  struct.mixed.add(_elem71);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.positions != null) {
        if (struct.isSetPositions()) {
          oprot.writeFieldBegin(POSITIONS_FIELD_DESC);
          {
            ...
            for (int _iter73 : struct.positions)
            {
      ...
      if (struct.mixed != null) {
        if (struct.isSetMixed()) {
          oprot.writeFieldBegin(MIXED_FIELD_DESC);
          {
            ...
            for (MixedReference _iter75 : struct.mixed)
            {
              _iter75.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPositions()) {
        {
          ...
          for (int _iter76 : struct.positions)
          {
      ...
      if (struct.isSetMixed()) {
        {
          ...
          for (MixedReference _iter78 : struct.mixed)
          {
            _iter78.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.positions = new ArrayList<Integer>(_list79.size);
          int _elem80;
          for (int _i81 = 0; _i81 < _list79.size; ++_i81)
      {
            _elem80 = iprot.readI32();
            struct.positions.add(_elem80);
          }
        }
        struct.setPositionsIsSet(true);
      }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.ids = new ArrayList<String>(_list82.size);
          String _elem83;
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.mixed = new ArrayList<MixedReference>(_list85.size);
          MixedReference _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new MixedReference();
            _elem86.read(iprot);
            struct.mixed.add(_elem86);
          }
        }
        struct.setMixedIsSet(true);
      }
