              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.source = new ArrayList<ModelSpec>(_list160.size);
                  ModelSpec _elem161;
                  for (int _i162 = 0; _i162 < _list160.size; ++_i162)
                  {
                    _elem161 = new ModelSpec();
                    _elem161.read(iprot);
                    struct.source.add(_elem161);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.target = new ArrayList<ModelSpec>(_list163.size);
                  ModelSpec _elem164;
                  for (int _i165 = 0; _i165 < _list163.size; ++_i165)
                  {
                    _elem164 = new ModelSpec();
                    _elem164.read(iprot);
                    struct.target.add(_elem164);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, launch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.source != null) {
          oprot.writeFieldBegin(SOURCE_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter166 : struct.source)
            {
        ...
        if (struct.target != null) {
          oprot.writeFieldBegin(TARGET_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter167 : struct.target)
            {
    ...
    private static class launch_argsTupleScheme extends TupleScheme<launch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.transformation);
        {
          ...
          for (ModelSpec _iter168 : struct.source)
          {
        ...
        }
        {
          ...
          for (ModelSpec _iter169 : struct.target)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        struct.setTransformationIsSet(true);
        {
          ...
          struct.source = new ArrayList<ModelSpec>(_list170.size);
          ModelSpec _elem171;
          for (int _i172 = 0; _i172 < _list170.size; ++_i172)
          {
            _elem171 = new ModelSpec();
            _elem171.read(iprot);
            struct.source.add(_elem171);
          }
        }
        struct.setSourceIsSet(true);
        {
          ...
          struct.target = new ArrayList<ModelSpec>(_list173.size);
          ModelSpec _elem174;
          for (int _i175 = 0; _i175 < _list173.size; ++_i175)
          {
            _elem174 = new ModelSpec();
            _elem174.read(iprot);
            struct.target.add(_elem174);
          }
        }
        struct.setTargetIsSet(true);
      }
