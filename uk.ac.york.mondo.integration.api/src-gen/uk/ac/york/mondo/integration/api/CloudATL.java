              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.source = new ArrayList<ModelSpec>(_list336.size);
                  ModelSpec _elem337;
                  for (int _i338 = 0; _i338 < _list336.size; ++_i338)
                  {
                    _elem337 = new ModelSpec();
                    _elem337.read(iprot);
                    struct.source.add(_elem337);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.target = new ArrayList<ModelSpec>(_list339.size);
                  ModelSpec _elem340;
                  for (int _i341 = 0; _i341 < _list339.size; ++_i341)
                  {
                    _elem340 = new ModelSpec();
                    _elem340.read(iprot);
                    struct.target.add(_elem340);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, launch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.source != null) {
          oprot.writeFieldBegin(SOURCE_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter342 : struct.source)
            {
        ...
        if (struct.target != null) {
          oprot.writeFieldBegin(TARGET_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter343 : struct.target)
            {
    ...
    private static class launch_argsTupleScheme extends TupleScheme<launch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.transformation);
        {
          ...
          for (ModelSpec _iter344 : struct.source)
          {
        ...
        }
        {
          ...
          for (ModelSpec _iter345 : struct.target)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        struct.setTransformationIsSet(true);
        {
          ...
          struct.source = new ArrayList<ModelSpec>(_list346.size);
          ModelSpec _elem347;
          for (int _i348 = 0; _i348 < _list346.size; ++_i348)
          {
            _elem347 = new ModelSpec();
            _elem347.read(iprot);
            struct.source.add(_elem347);
          }
        }
        struct.setSourceIsSet(true);
        {
          ...
          struct.target = new ArrayList<ModelSpec>(_list349.size);
          ModelSpec _elem350;
          for (int _i351 = 0; _i351 < _list349.size; ++_i351)
          {
            _elem350 = new ModelSpec();
            _elem350.read(iprot);
            struct.target.add(_elem350);
          }
        }
        struct.setTargetIsSet(true);
      }
