              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.source = new ArrayList<ModelSpec>(_list232.size);
                  ModelSpec _elem233;
                  for (int _i234 = 0; _i234 < _list232.size; ++_i234)
                  {
                    _elem233 = new ModelSpec();
                    _elem233.read(iprot);
                    struct.source.add(_elem233);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.target = new ArrayList<ModelSpec>(_list235.size);
                  ModelSpec _elem236;
                  for (int _i237 = 0; _i237 < _list235.size; ++_i237)
                  {
                    _elem236 = new ModelSpec();
                    _elem236.read(iprot);
                    struct.target.add(_elem236);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, launch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.source != null) {
          oprot.writeFieldBegin(SOURCE_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter238 : struct.source)
            {
        ...
        if (struct.target != null) {
          oprot.writeFieldBegin(TARGET_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter239 : struct.target)
            {
    ...
    private static class launch_argsTupleScheme extends TupleScheme<launch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.transformation);
        {
          ...
          for (ModelSpec _iter240 : struct.source)
          {
        ...
        }
        {
          ...
          for (ModelSpec _iter241 : struct.target)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        struct.setTransformationIsSet(true);
        {
          ...
          struct.source = new ArrayList<ModelSpec>(_list242.size);
          ModelSpec _elem243;
          for (int _i244 = 0; _i244 < _list242.size; ++_i244)
          {
            _elem243 = new ModelSpec();
            _elem243.read(iprot);
            struct.source.add(_elem243);
          }
        }
        struct.setSourceIsSet(true);
        {
          ...
          struct.target = new ArrayList<ModelSpec>(_list245.size);
          ModelSpec _elem246;
          for (int _i247 = 0; _i247 < _list245.size; ++_i247)
          {
            _elem246 = new ModelSpec();
            _elem246.read(iprot);
            struct.target.add(_elem246);
          }
        }
        struct.setTargetIsSet(true);
      }
