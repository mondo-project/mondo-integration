              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.resources = new ArrayList<CollaborationResourceReference>(_list136.size);
                  CollaborationResourceReference _elem137;
                  for (int _i138 = 0; _i138 < _list136.size; ++_i138)
                  {
                    _elem137 = new CollaborationResourceReference();
                    _elem137.read(iprot);
                    struct.resources.add(_elem137);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.resources != null) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for (CollaborationResourceReference _iter139 : struct.resources)
            {
    ...
    private static class checkout_argsTupleScheme extends TupleScheme<checkout_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        struct.credentials.write(oprot);
        {
          ...
          for (CollaborationResourceReference _iter140 : struct.resources)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        struct.setCredentialsIsSet(true);
        {
          ...
          struct.resources = new ArrayList<CollaborationResourceReference>(_list141.size);
          CollaborationResourceReference _elem142;
          for (int _i143 = 0; _i143 < _list141.size; ++_i143)
          {
            _elem142 = new CollaborationResourceReference();
            _elem142.read(iprot);
            struct.resources.add(_elem142);
          }
        }
        struct.setResourcesIsSet(true);
      }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list144.size);
                  CollaborationResource _elem145;
                  for (int _i146 = 0; _i146 < _list144.size; ++_i146)
                  {
                    _elem145 = new CollaborationResource();
                    _elem145.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (CollaborationResource _iter147 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (CollaborationResource _iter148 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list149.size);
            CollaborationResource _elem150;
            for (int _i151 = 0; _i151 < _list149.size; ++_i151)
            {
              _elem150 = new CollaborationResource();
              _elem150.read(iprot);
  ...
  public static class pull_args implements org.apache.thrift.TBase<pull_args, pull_args._Fields>, java.io.Serializable, Cloneable, Comparable<pull_args>   {
    ...
    private static class pull_argsStandardScheme extends StandardScheme<pull_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.resources = new ArrayList<CollaborationResourceReference>(_list160.size);
                  CollaborationResourceReference _elem161;
                  for (int _i162 = 0; _i162 < _list160.size; ++_i162)
                  {
                    _elem161 = new CollaborationResourceReference();
                    _elem161.read(iprot);
                    struct.resources.add(_elem161);
                  }
                  iprot.readListEnd();
                }
                struct.setResourcesIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pull_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.resources != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.resources.size()));
            for (CollaborationResourceReference _iter163 : struct.resources)
            {
    ...
    private static class pull_argsTupleScheme extends TupleScheme<pull_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, pull_args struct) throws org.apache.thrift.TException {
        ...
        {
          oprot.writeI32(struct.resources.size());
          for (CollaborationResourceReference _iter164 : struct.resources)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, pull_args struct) throws org.apache.thrift.TException {
        ...
        struct.setCredentialsIsSet(true);
        {
          ...
          struct.resources = new ArrayList<CollaborationResourceReference>(_list165.size);
          CollaborationResourceReference _elem166;
          for (int _i167 = 0; _i167 < _list165.size; ++_i167)
          {
            _elem166 = new CollaborationResourceReference();
            _elem166.read(iprot);
            struct.resources.add(_elem166);
          }
        }
        struct.setResourcesIsSet(true);
        struct.operationModel = new OperationModel();
    ...
    private static class pull_resultStandardScheme extends StandardScheme<pull_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list168.size);
                  CollaborationResource _elem169;
                  for (int _i170 = 0; _i170 < _list168.size; ++_i170)
                  {
                    _elem169 = new CollaborationResource();
                    _elem169.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pull_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (CollaborationResource _iter171 : struct.success)
            {
    ...
    private static class pull_resultTupleScheme extends TupleScheme<pull_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, pull_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (CollaborationResource _iter172 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list173.size);
            CollaborationResource _elem174;
            for (int _i175 = 0; _i175 < _list173.size; ++_i175)
            {
              _elem174 = new CollaborationResource();
              _elem174.read(iprot);
