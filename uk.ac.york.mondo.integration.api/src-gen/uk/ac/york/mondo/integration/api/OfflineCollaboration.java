              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.resources = new ArrayList<CollaborationResourceReference>(_list200.size);
                  CollaborationResourceReference _elem201;
                  for (int _i202 = 0; _i202 < _list200.size; ++_i202)
                  {
                    _elem201 = new CollaborationResourceReference();
                    _elem201.read(iprot);
                    struct.resources.add(_elem201);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.resources != null) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for (CollaborationResourceReference _iter203 : struct.resources)
            {
    ...
    private static class checkout_argsTupleScheme extends TupleScheme<checkout_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        struct.credentials.write(oprot);
        {
          ...
          for (CollaborationResourceReference _iter204 : struct.resources)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        struct.setCredentialsIsSet(true);
        {
          ...
          struct.resources = new ArrayList<CollaborationResourceReference>(_list205.size);
          CollaborationResourceReference _elem206;
          for (int _i207 = 0; _i207 < _list205.size; ++_i207)
          {
            _elem206 = new CollaborationResourceReference();
            _elem206.read(iprot);
            struct.resources.add(_elem206);
          }
        }
        struct.setResourcesIsSet(true);
      }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list208.size);
                  CollaborationResource _elem209;
                  for (int _i210 = 0; _i210 < _list208.size; ++_i210)
                  {
                    _elem209 = new CollaborationResource();
                    _elem209.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (CollaborationResource _iter211 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (CollaborationResource _iter212 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list213.size);
            CollaborationResource _elem214;
            for (int _i215 = 0; _i215 < _list213.size; ++_i215)
            {
              _elem214 = new CollaborationResource();
              _elem214.read(iprot);
