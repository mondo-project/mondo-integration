              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.resources = new ArrayList<CollaborationResourceReference>(_list328.size);
                  CollaborationResourceReference _elem329;
                  for (int _i330 = 0; _i330 < _list328.size; ++_i330)
                  {
                    _elem329 = new CollaborationResourceReference();
                    _elem329.read(iprot);
                    struct.resources.add(_elem329);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.resources != null) {
          oprot.writeFieldBegin(RESOURCES_FIELD_DESC);
          {
            ...
            for (CollaborationResourceReference _iter331 : struct.resources)
            {
    ...
    private static class checkout_argsTupleScheme extends TupleScheme<checkout_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        struct.credentials.write(oprot);
        {
          ...
          for (CollaborationResourceReference _iter332 : struct.resources)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, checkout_args struct) throws org.apache.thrift.TException {
        ...
        struct.setCredentialsIsSet(true);
        {
          ...
          struct.resources = new ArrayList<CollaborationResourceReference>(_list333.size);
          CollaborationResourceReference _elem334;
          for (int _i335 = 0; _i335 < _list333.size; ++_i335)
          {
            _elem334 = new CollaborationResourceReference();
            _elem334.read(iprot);
            struct.resources.add(_elem334);
          }
        }
        struct.setResourcesIsSet(true);
      }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list336.size);
                  CollaborationResource _elem337;
                  for (int _i338 = 0; _i338 < _list336.size; ++_i338)
                  {
                    _elem337 = new CollaborationResource();
                    _elem337.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (CollaborationResource _iter339 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (CollaborationResource _iter340 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list341.size);
            CollaborationResource _elem342;
            for (int _i343 = 0; _i343 < _list341.size; ++_i343)
            {
              _elem342 = new CollaborationResource();
              _elem342.read(iprot);
  ...
  public static class pull_args implements org.apache.thrift.TBase<pull_args, pull_args._Fields>, java.io.Serializable, Cloneable, Comparable<pull_args>   {
    ...
    private static class pull_argsStandardScheme extends StandardScheme<pull_args> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.resources = new ArrayList<CollaborationResourceReference>(_list352.size);
                  CollaborationResourceReference _elem353;
                  for (int _i354 = 0; _i354 < _list352.size; ++_i354)
                  {
                    _elem353 = new CollaborationResourceReference();
                    _elem353.read(iprot);
                    struct.resources.add(_elem353);
                  }
                  iprot.readListEnd();
                }
                struct.setResourcesIsSet(true);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pull_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.resources != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.resources.size()));
            for (CollaborationResourceReference _iter355 : struct.resources)
            {
    ...
    private static class pull_argsTupleScheme extends TupleScheme<pull_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, pull_args struct) throws org.apache.thrift.TException {
        ...
        {
          oprot.writeI32(struct.resources.size());
          for (CollaborationResourceReference _iter356 : struct.resources)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, pull_args struct) throws org.apache.thrift.TException {
        ...
        struct.setCredentialsIsSet(true);
        {
          ...
          struct.resources = new ArrayList<CollaborationResourceReference>(_list357.size);
          CollaborationResourceReference _elem358;
          for (int _i359 = 0; _i359 < _list357.size; ++_i359)
          {
            _elem358 = new CollaborationResourceReference();
            _elem358.read(iprot);
            struct.resources.add(_elem358);
          }
        }
        struct.setResourcesIsSet(true);
        struct.operationModel = new OperationModel();
    ...
    private static class pull_resultStandardScheme extends StandardScheme<pull_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list360.size);
                  CollaborationResource _elem361;
                  for (int _i362 = 0; _i362 < _list360.size; ++_i362)
                  {
                    _elem361 = new CollaborationResource();
                    _elem361.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pull_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (CollaborationResource _iter363 : struct.success)
            {
    ...
    private static class pull_resultTupleScheme extends TupleScheme<pull_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, pull_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (CollaborationResource _iter364 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list365.size);
            CollaborationResource _elem366;
            for (int _i367 = 0; _i367 < _list365.size; ++_i367)
            {
              _elem366 = new CollaborationResource();
              _elem366.read(iprot);
