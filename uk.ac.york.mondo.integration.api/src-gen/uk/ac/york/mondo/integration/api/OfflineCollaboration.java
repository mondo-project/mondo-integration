              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationRule>(_list306.size);
                  CollaborationRule _elem307;
                  for (int _i308 = 0; _i308 < _list306.size; ++_i308)
                  {
                    _elem307 = new CollaborationRule();
                    _elem307.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listRules_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (CollaborationRule _iter309 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (CollaborationRule _iter310 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationRule>(_list311.size);
            CollaborationRule _elem312;
            for (int _i313 = 0; _i313 < _list311.size; ++_i313)
            {
              _elem312 = new CollaborationRule();
              _elem312.read(iprot);
