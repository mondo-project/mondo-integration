              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list264.size);
                  CollaborationResource _elem265;
                  for (int _i266 = 0; _i266 < _list264.size; ++_i266)
                  {
                    _elem265 = new CollaborationResource();
                    _elem265.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (CollaborationResource _iter267 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (CollaborationResource _iter268 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list269.size);
            CollaborationResource _elem270;
            for (int _i271 = 0; _i271 < _list269.size; ++_i271)
            {
              _elem270 = new CollaborationResource();
              _elem270.read(iprot);
