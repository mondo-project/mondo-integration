              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list152.size);
                  CollaborationResource _elem153;
                  for (int _i154 = 0; _i154 < _list152.size; ++_i154)
                  {
                    _elem153 = new CollaborationResource();
                    _elem153.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, checkout_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (CollaborationResource _iter155 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (CollaborationResource _iter156 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list157.size);
            CollaborationResource _elem158;
            for (int _i159 = 0; _i159 < _list157.size; ++_i159)
            {
              _elem158 = new CollaborationResource();
              _elem158.read(iprot);
    ...
    private static class pull_resultStandardScheme extends StandardScheme<pull_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<CollaborationResource>(_list176.size);
                  CollaborationResource _elem177;
                  for (int _i178 = 0; _i178 < _list176.size; ++_i178)
                  {
                    _elem177 = new CollaborationResource();
                    _elem177.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, pull_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (CollaborationResource _iter179 : struct.success)
            {
    ...
    private static class pull_resultTupleScheme extends TupleScheme<pull_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, pull_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (CollaborationResource _iter180 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<CollaborationResource>(_list181.size);
            CollaborationResource _elem182;
            for (int _i183 = 0; _i183 < _list181.size; ++_i183)
            {
              _elem182 = new CollaborationResource();
              _elem182.read(iprot);
