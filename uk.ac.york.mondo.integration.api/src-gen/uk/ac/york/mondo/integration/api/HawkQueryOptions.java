...
public class HawkQueryOptions implements org.apache.thrift.TBase<HawkQueryOptions, HawkQueryOptions._Fields>, java.io.Serializable, Cloneable, Comparable<HawkQueryOptions> {
  ...
  private static final org.apache.thrift.protocol.TField EFFECTIVE_METAMODEL_FIELD_DESC = new org.apache.thrift.protocol.TField("effectiveMetamodel", org.apache.thrift.protocol.TType.MAP, (short)8);
  ...
  public Map<String,List<String>> effectiveMetamodel; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    EFFECTIVE_METAMODEL((short)8, "effectiveMetamodel");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 8: // EFFECTIVE_METAMODEL
          return EFFECTIVE_METAMODEL;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.REPOSITORY_PATTERN,_Fields.FILE_PATTERNS,_Fields.DEFAULT_NAMESPACES,_Fields.INCLUDE_ATTRIBUTES,_Fields.INCLUDE_REFERENCES,_Fields.INCLUDE_NODE_IDS,_Fields.INCLUDE_CONTAINED,_Fields.EFFECTIVE_METAMODEL};
  ...
  static {
    ...
    tmpMap.put(_Fields.INCLUDE_CONTAINED, new org.apache.thrift.meta_data.FieldMetaData("includeContained", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.EFFECTIVE_METAMODEL, new org.apache.thrift.meta_data.FieldMetaData("effectiveMetamodel", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
  ...
  public HawkQueryOptions(HawkQueryOptions other) {
    ...
    if (other.isSetEffectiveMetamodel()) {
      Map<String,List<String>> __this__effectiveMetamodel = new HashMap<String,List<String>>(other.effectiveMetamodel.size());
      for (Map.Entry<String, List<String>> other_element : other.effectiveMetamodel.entrySet()) {

        String other_element_key = other_element.getKey();
        List<String> other_element_value = other_element.getValue();

        String __this__effectiveMetamodel_copy_key = other_element_key;

        List<String> __this__effectiveMetamodel_copy_value = new ArrayList<String>(other_element_value);

        __this__effectiveMetamodel.put(__this__effectiveMetamodel_copy_key, __this__effectiveMetamodel_copy_value);
      }
      this.effectiveMetamodel = __this__effectiveMetamodel;
    }
  }
  ...
  public int getEffectiveMetamodelSize() {
    return (this.effectiveMetamodel == null) ? 0 : this.effectiveMetamodel.size();
  }

  public void putToEffectiveMetamodel(String key, List<String> val) {
    if (this.effectiveMetamodel == null) {
      this.effectiveMetamodel = new HashMap<String,List<String>>();
    }
    this.effectiveMetamodel.put(key, val);
  }

  public Map<String,List<String>> getEffectiveMetamodel() {
    return this.effectiveMetamodel;
  }

  public HawkQueryOptions setEffectiveMetamodel(Map<String,List<String>> effectiveMetamodel) {
    this.effectiveMetamodel = effectiveMetamodel;
    return this;
  }

  public void unsetEffectiveMetamodel() {
    this.effectiveMetamodel = null;
  }

  /** Returns true if field effectiveMetamodel is set (has been assigned a value) and false otherwise */
  public boolean isSetEffectiveMetamodel() {
    return this.effectiveMetamodel != null;
  }

  public void setEffectiveMetamodelIsSet(boolean value) {
    if (!value) {
      this.effectiveMetamodel = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case EFFECTIVE_METAMODEL:
      if (value == null) {
        unsetEffectiveMetamodel();
      } else {
        setEffectiveMetamodel((Map<String,List<String>>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case EFFECTIVE_METAMODEL:
      return isSetEffectiveMetamodel();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(HawkQueryOptions that) {
    ...
    boolean this_present_effectiveMetamodel = true && this.isSetEffectiveMetamodel();
    boolean that_present_effectiveMetamodel = true && that.isSetEffectiveMetamodel();
    if (this_present_effectiveMetamodel || that_present_effectiveMetamodel) {
      if (!(this_present_effectiveMetamodel && that_present_effectiveMetamodel))
        return false;
      if (!this.effectiveMetamodel.equals(that.effectiveMetamodel))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_effectiveMetamodel = true && (isSetEffectiveMetamodel());
    list.add(present_effectiveMetamodel);
    if (present_effectiveMetamodel)
      list.add(effectiveMetamodel);
  ...
  public int compareTo(HawkQueryOptions other) {
    ...
    lastComparison = Boolean.valueOf(isSetEffectiveMetamodel()).compareTo(other.isSetEffectiveMetamodel());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEffectiveMetamodel()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.effectiveMetamodel, other.effectiveMetamodel);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetEffectiveMetamodel()) {
      if (!first) sb.append(", ");
      sb.append("effectiveMetamodel:");
      if (this.effectiveMetamodel == null) {
        sb.append("null");
      } else {
        sb.append(this.effectiveMetamodel);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class HawkQueryOptionsStandardScheme extends StandardScheme<HawkQueryOptions> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.filePatterns = new ArrayList<String>(_list56.size);
                String _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = iprot.readString();
                  struct.filePatterns.add(_elem57);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.effectiveMetamodel = new HashMap<String,List<String>>(2*_map59.size);
                String _key60;
                List<String> _val61;
                for (int _i62 = 0; _i62 < _map59.size; ++_i62)
                {
                  ...
                  struct.effectiveMetamodel.put(_key60, _val61);
                }
                iprot.readMapEnd();
              }
              struct.setEffectiveMetamodelIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HawkQueryOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.filePatterns != null) {
        if (struct.isSetFilePatterns()) {
          oprot.writeFieldBegin(FILE_PATTERNS_FIELD_DESC);
          {
            ...
            for (String _iter66 : struct.filePatterns)
            {
      ...
      if (struct.effectiveMetamodel != null) {
        if (struct.isSetEffectiveMetamodel()) {
          oprot.writeFieldBegin(EFFECTIVE_METAMODEL_FIELD_DESC);
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.LIST, struct.effectiveMetamodel.size()));
            for (Map.Entry<String, List<String>> _iter67 : struct.effectiveMetamodel.entrySet())
            {
  ...
  private static class HawkQueryOptionsTupleScheme extends TupleScheme<HawkQueryOptions> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, HawkQueryOptions struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetFilePatterns()) {
        {
          ...
          for (String _iter69 : struct.filePatterns)
          {
      ...
      if (struct.isSetEffectiveMetamodel()) {
        {
          oprot.writeI32(struct.effectiveMetamodel.size());
          for (Map.Entry<String, List<String>> _iter70 : struct.effectiveMetamodel.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.filePatterns = new ArrayList<String>(_list72.size);
          String _elem73;
          for (int _i74 = 0; _i74 < _list72.size; ++_i74)
          {
            _elem73 = iprot.readString();
            struct.filePatterns.add(_elem73);
          }
        }
        struct.setFilePatternsIsSet(true);
      }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.effectiveMetamodel = new HashMap<String,List<String>>(2*_map75.size);
          String _key76;
          List<String> _val77;
          for (int _i78 = 0; _i78 < _map75.size; ++_i78)
          {
            _key76 = iprot.readString();
            {
              ...
              _val77 = new ArrayList<String>(_list79.size);
              String _elem80;
            ...
            struct.effectiveMetamodel.put(_key76, _val77);
          }
        }
        struct.setEffectiveMetamodelIsSet(true);
      }
