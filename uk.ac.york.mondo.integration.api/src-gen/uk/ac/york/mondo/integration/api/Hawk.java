    ...
    private static class listDerivedAttributes_resultStandardScheme extends StandardScheme<listDerivedAttributes_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<DerivedAttributeSpec>(_list104.size);
                  DerivedAttributeSpec _elem105;
                  for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                  {
                    _elem105 = new DerivedAttributeSpec();
                    _elem105.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listDerivedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (DerivedAttributeSpec _iter107 : struct.success)
            {
    ...
    private static class listDerivedAttributes_resultTupleScheme extends TupleScheme<listDerivedAttributes_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, listDerivedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (DerivedAttributeSpec _iter108 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<DerivedAttributeSpec>(_list109.size);
            DerivedAttributeSpec _elem110;
            for (int _i111 = 0; _i111 < _list109.size; ++_i111)
            {
              _elem110 = new DerivedAttributeSpec();
              _elem110.read(iprot);
    ...
    private static class listIndexedAttributes_resultStandardScheme extends StandardScheme<listIndexedAttributes_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<IndexedAttributeSpec>(_list112.size);
                  IndexedAttributeSpec _elem113;
                  for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                  {
                    _elem113 = new IndexedAttributeSpec();
                    _elem113.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listIndexedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (IndexedAttributeSpec _iter115 : struct.success)
            {
    ...
    private static class listIndexedAttributes_resultTupleScheme extends TupleScheme<listIndexedAttributes_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, listIndexedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (IndexedAttributeSpec _iter116 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<IndexedAttributeSpec>(_list117.size);
            IndexedAttributeSpec _elem118;
            for (int _i119 = 0; _i119 < _list117.size; ++_i119)
            {
              _elem118 = new IndexedAttributeSpec();
              _elem118.read(iprot);
    ...
    private static class getAllContents_resultStandardScheme extends StandardScheme<getAllContents_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ModelElement>(_list120.size);
                  ModelElement _elem121;
                  for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                  {
                    _elem121 = new ModelElement();
                    _elem121.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllContents_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ModelElement _iter123 : struct.success)
            {
    ...
    private static class getAllContents_resultTupleScheme extends TupleScheme<getAllContents_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllContents_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ModelElement _iter124 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ModelElement>(_list125.size);
            ModelElement _elem126;
            for (int _i127 = 0; _i127 < _list125.size; ++_i127)
            {
              _elem126 = new ModelElement();
              _elem126.read(iprot);
