...
public class Hawk {
  ...
  public interface Iface {
    ...
    public List<ScalarOrReference> query(String name, String query, String language, String scope) throws HawkInstanceNotFound, HawkInstanceNotRunning, UnknownQueryLanguage, InvalidQuery, org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public List<ScalarOrReference> recv_query() throws HawkInstanceNotFound, HawkInstanceNotRunning, UnknownQueryLanguage, InvalidQuery, org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class query_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public List<ScalarOrReference> getResult() throws HawkInstanceNotFound, HawkInstanceNotRunning, UnknownQueryLanguage, InvalidQuery, org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class query<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, query_args, List<ScalarOrReference>> {
      public query() {
        super("query");
      }
      ...
      public AsyncMethodCallback<List<ScalarOrReference>> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<List<ScalarOrReference>>() { 
          public void onComplete(List<ScalarOrReference> o) {
            query_result result = new query_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, query_args args, org.apache.thrift.async.AsyncMethodCallback<List<ScalarOrReference>> resultHandler) throws TException {
...
;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<HawkInstance>(_list104.size);
                  HawkInstance _elem105;
                  for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                  {
                    _elem105 = new HawkInstance();
                    _elem105.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listInstances_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (HawkInstance _iter107 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (HawkInstance _iter108 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<HawkInstance>(_list109.size);
            HawkInstance _elem110;
            for (int _i111 = 0; _i111 < _list109.size; ++_i111)
            {
              _elem110 = new HawkInstance();
              _elem110.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.metamodel = new ArrayList<File>(_list112.size);
                  File _elem113;
                  for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                  {
                    _elem113 = new File();
                    _elem113.read(iprot);
                    struct.metamodel.add(_elem113);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, registerMetamodels_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.metamodel != null) {
          oprot.writeFieldBegin(METAMODEL_FIELD_DESC);
          {
            ...
            for (File _iter115 : struct.metamodel)
            {
    ...
    private static class registerMetamodels_argsTupleScheme extends TupleScheme<registerMetamodels_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, registerMetamodels_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.name);
        {
          ...
          for (File _iter116 : struct.metamodel)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, registerMetamodels_args struct) throws org.apache.thrift.TException {
        ...
        struct.setNameIsSet(true);
        {
          ...
          struct.metamodel = new ArrayList<File>(_list117.size);
          File _elem118;
          for (int _i119 = 0; _i119 < _list117.size; ++_i119)
          {
            _elem118 = new File();
            _elem118.read(iprot);
            struct.metamodel.add(_elem118);
          }
        }
        struct.setMetamodelIsSet(true);
      }
  ...
  public static class query_result implements org.apache.thrift.TBase<query_result, query_result._Fields>, java.io.Serializable, Cloneable, Comparable<query_result>   {
    ...
    public List<ScalarOrReference> success; // required
    public HawkInstanceNotFound err1; // required
    public HawkInstanceNotRunning err2; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
              new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, ScalarOrReference.class))));
      tmpMap.put(_Fields.ERR1, new org.apache.thrift.meta_data.FieldMetaData("err1", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
      tmpMap.put(_Fields.ERR2, new org.apache.thrift.meta_data.FieldMetaData("err2", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT)));
    ...
    public query_result(
      List<ScalarOrReference> success,
      HawkInstanceNotFound err1,
      HawkInstanceNotRunning err2,
    ...
    public query_result(query_result other) {
      if (other.isSetSuccess()) {
        List<ScalarOrReference> __this__success = new ArrayList<ScalarOrReference>(other.success.size());
        for (ScalarOrReference other_element : other.success) {
          __this__success.add(new ScalarOrReference(other_element));
        }
        this.success = __this__success;
      }
      if (other.isSetErr1()) {
    ...
    public java.util.Iterator<ScalarOrReference> getSuccessIterator() {
      return (this.success == null) ? null : this.success.iterator();
    }

    public void addToSuccess(ScalarOrReference elem) {
      if (this.success == null) {
        this.success = new ArrayList<ScalarOrReference>();
      }
      this.success.add(elem);
    }

    public List<ScalarOrReference> getSuccess() {
      return this.success;
    }

    public query_result setSuccess(List<ScalarOrReference> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((List<ScalarOrReference>)value);
        }
        break;
    ...
    private static class query_resultStandardScheme extends StandardScheme<query_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ScalarOrReference>(_list136.size);
                  ScalarOrReference _elem137;
                  for (int _i138 = 0; _i138 < _list136.size; ++_i138)
                  {
                    _elem137 = new ScalarOrReference();
                    _elem137.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, query_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ScalarOrReference _iter139 : struct.success)
            {
    ...
    private static class query_resultTupleScheme extends TupleScheme<query_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, query_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ScalarOrReference _iter140 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ScalarOrReference>(_list141.size);
            ScalarOrReference _elem142;
            for (int _i143 = 0; _i143 < _list141.size; ++_i143)
            {
              _elem142 = new ScalarOrReference();
              _elem142.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.ids = new ArrayList<String>(_list144.size);
                  String _elem145;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, resolveProxies_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.ids != null) {
          oprot.writeFieldBegin(IDS_FIELD_DESC);
          {
            ...
            for (String _iter147 : struct.ids)
            {
    ...
    private static class resolveProxies_argsTupleScheme extends TupleScheme<resolveProxies_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, resolveProxies_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.name);
        {
          ...
          for (String _iter148 : struct.ids)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, resolveProxies_args struct) throws org.apache.thrift.TException {
        ...
        struct.setNameIsSet(true);
        {
          ...
          struct.ids = new ArrayList<String>(_list149.size);
          String _elem150;
          for (int _i151 = 0; _i151 < _list149.size; ++_i151)
          {
            _elem150 = iprot.readString();
            struct.ids.add(_elem150);
          }
        }
        struct.setIdsIsSet(true);
      }
    ...
    private static class listDerivedAttributes_resultStandardScheme extends StandardScheme<listDerivedAttributes_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<DerivedAttributeSpec>(_list184.size);
                  DerivedAttributeSpec _elem185;
                  for (int _i186 = 0; _i186 < _list184.size; ++_i186)
                  {
                    _elem185 = new DerivedAttributeSpec();
                    _elem185.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listDerivedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (DerivedAttributeSpec _iter187 : struct.success)
            {
    ...
    private static class listDerivedAttributes_resultTupleScheme extends TupleScheme<listDerivedAttributes_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, listDerivedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (DerivedAttributeSpec _iter188 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<DerivedAttributeSpec>(_list189.size);
            DerivedAttributeSpec _elem190;
            for (int _i191 = 0; _i191 < _list189.size; ++_i191)
            {
              _elem190 = new DerivedAttributeSpec();
              _elem190.read(iprot);
    ...
    private static class listIndexedAttributes_resultStandardScheme extends StandardScheme<listIndexedAttributes_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<IndexedAttributeSpec>(_list192.size);
                  IndexedAttributeSpec _elem193;
                  for (int _i194 = 0; _i194 < _list192.size; ++_i194)
                  {
                    _elem193 = new IndexedAttributeSpec();
                    _elem193.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listIndexedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (IndexedAttributeSpec _iter195 : struct.success)
            {
    ...
    private static class listIndexedAttributes_resultTupleScheme extends TupleScheme<listIndexedAttributes_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, listIndexedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (IndexedAttributeSpec _iter196 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<IndexedAttributeSpec>(_list197.size);
            IndexedAttributeSpec _elem198;
            for (int _i199 = 0; _i199 < _list197.size; ++_i199)
            {
              _elem198 = new IndexedAttributeSpec();
              _elem198.read(iprot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.filePath = new ArrayList<String>(_list200.size);
                  String _elem201;
                  for (int _i202 = 0; _i202 < _list200.size; ++_i202)
                  {
                    _elem201 = iprot.readString();
                    struct.filePath.add(_elem201);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getModel_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.filePath != null) {
          oprot.writeFieldBegin(FILE_PATH_FIELD_DESC);
          {
            ...
            for (String _iter203 : struct.filePath)
            {
    ...
    private static class getModel_argsTupleScheme extends TupleScheme<getModel_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getModel_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.repositoryUri);
        {
          ...
          for (String _iter204 : struct.filePath)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, getModel_args struct) throws org.apache.thrift.TException {
        ...
        struct.setRepositoryUriIsSet(true);
        {
          ...
          struct.filePath = new ArrayList<String>(_list205.size);
          String _elem206;
          for (int _i207 = 0; _i207 < _list205.size; ++_i207)
          {
            _elem206 = iprot.readString();
            struct.filePath.add(_elem206);
          }
        }
        struct.setFilePathIsSet(true);
      }
    ...
    private static class getModel_resultStandardScheme extends StandardScheme<getModel_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ModelElement>(_list208.size);
                  ModelElement _elem209;
                  for (int _i210 = 0; _i210 < _list208.size; ++_i210)
                  {
                    _elem209 = new ModelElement();
                    _elem209.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getModel_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ModelElement _iter211 : struct.success)
            {
    ...
    private static class getModel_resultTupleScheme extends TupleScheme<getModel_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getModel_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ModelElement _iter212 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ModelElement>(_list213.size);
            ModelElement _elem214;
            for (int _i215 = 0; _i215 < _list213.size; ++_i215)
            {
              _elem214 = new ModelElement();
              _elem214.read(iprot);
