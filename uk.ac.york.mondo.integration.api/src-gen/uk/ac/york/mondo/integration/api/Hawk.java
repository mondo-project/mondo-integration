              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.ids = new ArrayList<String>(_list72.size);
                  String _elem73;
    ...
    private static class resolveProxies_argsTupleScheme extends TupleScheme<resolveProxies_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, resolveProxies_args struct) throws org.apache.thrift.TException {
        ...
        struct.setNameIsSet(true);
        {
          ...
          struct.ids = new ArrayList<String>(_list77.size);
          String _elem78;
    ...
    private static class resolveProxies_resultStandardScheme extends StandardScheme<resolveProxies_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ModelElement>(_list80.size);
                  ModelElement _elem81;
                  for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                  {
                    _elem81 = new ModelElement();
                    _elem81.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, resolveProxies_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ModelElement _iter83 : struct.success)
            {
              _iter83.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class resolveProxies_resultTupleScheme extends TupleScheme<resolveProxies_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, resolveProxies_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ModelElement _iter84 : struct.success)
            {
              _iter84.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ModelElement>(_list85.size);
            ModelElement _elem86;
            for (int _i87 = 0; _i87 < _list85.size; ++_i87)
            {
              _elem86 = new ModelElement();
              _elem86.read(iprot);
    ...
    private static class listDerivedAttributes_resultStandardScheme extends StandardScheme<listDerivedAttributes_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<DerivedAttributeSpec>(_list112.size);
                  DerivedAttributeSpec _elem113;
                  for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                  {
                    _elem113 = new DerivedAttributeSpec();
                    _elem113.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listDerivedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (DerivedAttributeSpec _iter115 : struct.success)
            {
    ...
    private static class listDerivedAttributes_resultTupleScheme extends TupleScheme<listDerivedAttributes_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, listDerivedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (DerivedAttributeSpec _iter116 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<DerivedAttributeSpec>(_list117.size);
            DerivedAttributeSpec _elem118;
            for (int _i119 = 0; _i119 < _list117.size; ++_i119)
            {
              _elem118 = new DerivedAttributeSpec();
              _elem118.read(iprot);
    ...
    private static class listIndexedAttributes_resultStandardScheme extends StandardScheme<listIndexedAttributes_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<IndexedAttributeSpec>(_list120.size);
                  IndexedAttributeSpec _elem121;
                  for (int _i122 = 0; _i122 < _list120.size; ++_i122)
                  {
                    _elem121 = new IndexedAttributeSpec();
                    _elem121.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, listIndexedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (IndexedAttributeSpec _iter123 : struct.success)
            {
    ...
    private static class listIndexedAttributes_resultTupleScheme extends TupleScheme<listIndexedAttributes_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, listIndexedAttributes_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (IndexedAttributeSpec _iter124 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<IndexedAttributeSpec>(_list125.size);
            IndexedAttributeSpec _elem126;
            for (int _i127 = 0; _i127 < _list125.size; ++_i127)
            {
              _elem126 = new IndexedAttributeSpec();
              _elem126.read(iprot);
    ...
    private static class getAllContents_resultStandardScheme extends StandardScheme<getAllContents_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<ModelElement>(_list128.size);
                  ModelElement _elem129;
                  for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                  {
                    _elem129 = new ModelElement();
                    _elem129.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAllContents_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (ModelElement _iter131 : struct.success)
            {
    ...
    private static class getAllContents_resultTupleScheme extends TupleScheme<getAllContents_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, getAllContents_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (ModelElement _iter132 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<ModelElement>(_list133.size);
            ModelElement _elem134;
            for (int _i135 = 0; _i135 < _list133.size; ++_i135)
            {
              _elem134 = new ModelElement();
              _elem134.read(iprot);
