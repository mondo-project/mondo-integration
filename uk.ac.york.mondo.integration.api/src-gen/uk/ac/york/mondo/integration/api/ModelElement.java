            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list88.size);
                AttributeSlot _elem89;
                for (int _i90 = 0; _i90 < _list88.size; ++_i90)
                {
                  _elem89 = new AttributeSlot();
                  _elem89.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list91.size);
                ReferenceSlot _elem92;
                for (int _i93 = 0; _i93 < _list91.size; ++_i93)
                {
                  _elem92 = new ReferenceSlot();
                  _elem92.read(iprot);
                  struct.references.add(_elem92);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list94.size);
                ContainerSlot _elem95;
                for (int _i96 = 0; _i96 < _list94.size; ++_i96)
                {
                  _elem95 = new ContainerSlot();
                  _elem95.read(iprot);
                  struct.containers.add(_elem95);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter97 : struct.attributes)
            {
              _iter97.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter98 : struct.references)
            {
              _iter98.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter99 : struct.containers)
            {
              _iter99.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter100 : struct.attributes)
          {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter101 : struct.references)
          {
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter102 : struct.containers)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list103.size);
          AttributeSlot _elem104;
          for (int _i105 = 0; _i105 < _list103.size; ++_i105)
          {
            _elem104 = new AttributeSlot();
            _elem104.read(iprot);
            struct.attributes.add(_elem104);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list106.size);
          ReferenceSlot _elem107;
          for (int _i108 = 0; _i108 < _list106.size; ++_i108)
          {
            _elem107 = new ReferenceSlot();
            _elem107.read(iprot);
            struct.references.add(_elem107);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list109.size);
          ContainerSlot _elem110;
          for (int _i111 = 0; _i111 < _list109.size; ++_i111)
          {
            _elem110 = new ContainerSlot();
            _elem110.read(iprot);
            struct.containers.add(_elem110);
          }
        }
        struct.setContainersIsSet(true);
      }
