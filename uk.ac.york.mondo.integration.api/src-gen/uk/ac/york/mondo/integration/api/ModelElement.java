...
public class ModelElement implements org.apache.thrift.TBase<ModelElement, ModelElement._Fields>, java.io.Serializable, Cloneable, Comparable<ModelElement> {
  ...
  public List<AttributeSlot> attributes; // required
  public List<ReferenceSlot> references; // required
  ...
  public ModelElement(
    ...
    String metamodelUri,
    String typeName,
    List<AttributeSlot> attributes,
    List<ReferenceSlot> references)
  {
    this();
    this.id = id;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list64.size);
                AttributeSlot _elem65;
                for (int _i66 = 0; _i66 < _list64.size; ++_i66)
                {
                  _elem65 = new AttributeSlot();
                  _elem65.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list67.size);
                ReferenceSlot _elem68;
                for (int _i69 = 0; _i69 < _list67.size; ++_i69)
                {
                  _elem68 = new ReferenceSlot();
                  _elem68.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ModelElement struct) throws org.apache.thrift.TException {
      ...
      if (struct.attributes != null) {
        oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
        {
          ...
          for (AttributeSlot _iter70 : struct.attributes)
          {
            _iter70.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.references != null) {
        oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
        {
          ...
          for (ReferenceSlot _iter71 : struct.references)
          {
            _iter71.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class ModelElementTupleScheme extends TupleScheme<ModelElement> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ModelElement struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.typeName);
      {
        ...
        for (AttributeSlot _iter72 : struct.attributes)
        {
          _iter72.write(oprot);
        }
      }
      {
        ...
        for (ReferenceSlot _iter73 : struct.references)
        {
          _iter73.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ModelElement struct) throws org.apache.thrift.TException {
      ...
      struct.setTypeNameIsSet(true);
      {
        ...
        struct.attributes = new ArrayList<AttributeSlot>(_list74.size);
        AttributeSlot _elem75;
        for (int _i76 = 0; _i76 < _list74.size; ++_i76)
        {
          _elem75 = new AttributeSlot();
          _elem75.read(iprot);
      ...
      struct.setAttributesIsSet(true);
      {
        ...
        struct.references = new ArrayList<ReferenceSlot>(_list77.size);
        ReferenceSlot _elem78;
        for (int _i79 = 0; _i79 < _list77.size; ++_i79)
        {
          _elem78 = new ReferenceSlot();
          _elem78.read(iprot);
