            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list80.size);
                AttributeSlot _elem81;
                for (int _i82 = 0; _i82 < _list80.size; ++_i82)
                {
                  _elem81 = new AttributeSlot();
                  _elem81.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list83.size);
                ReferenceSlot _elem84;
                for (int _i85 = 0; _i85 < _list83.size; ++_i85)
                {
                  _elem84 = new ReferenceSlot();
                  _elem84.read(iprot);
                  struct.references.add(_elem84);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list86.size);
                ContainerSlot _elem87;
                for (int _i88 = 0; _i88 < _list86.size; ++_i88)
                {
                  _elem87 = new ContainerSlot();
                  _elem87.read(iprot);
                  struct.containers.add(_elem87);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter89 : struct.attributes)
            {
              _iter89.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter90 : struct.references)
            {
              _iter90.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter91 : struct.containers)
            {
              _iter91.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter92 : struct.attributes)
          {
            _iter92.write(oprot);
          }
        }
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter93 : struct.references)
          {
            _iter93.write(oprot);
          }
        }
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter94 : struct.containers)
          {
            _iter94.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list95.size);
          AttributeSlot _elem96;
          for (int _i97 = 0; _i97 < _list95.size; ++_i97)
          {
            _elem96 = new AttributeSlot();
            _elem96.read(iprot);
            struct.attributes.add(_elem96);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(4)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list98.size);
          ReferenceSlot _elem99;
          for (int _i100 = 0; _i100 < _list98.size; ++_i100)
          {
            _elem99 = new ReferenceSlot();
            _elem99.read(iprot);
            struct.references.add(_elem99);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(5)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list101.size);
          ContainerSlot _elem102;
          for (int _i103 = 0; _i103 < _list101.size; ++_i103)
          {
            _elem102 = new ContainerSlot();
            _elem102.read(iprot);
            struct.containers.add(_elem102);
          }
        }
        struct.setContainersIsSet(true);
      }
