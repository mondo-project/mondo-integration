            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list122.size);
                AttributeSlot _elem123;
                for (int _i124 = 0; _i124 < _list122.size; ++_i124)
                {
                  _elem123 = new AttributeSlot();
                  _elem123.read(iprot);
                  struct.attributes.add(_elem123);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list125.size);
                ReferenceSlot _elem126;
                for (int _i127 = 0; _i127 < _list125.size; ++_i127)
                {
                  _elem126 = new ReferenceSlot();
                  _elem126.read(iprot);
                  struct.references.add(_elem126);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list128.size);
                ContainerSlot _elem129;
                for (int _i130 = 0; _i130 < _list128.size; ++_i130)
                {
                  _elem129 = new ContainerSlot();
                  _elem129.read(iprot);
                  struct.containers.add(_elem129);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter131 : struct.attributes)
            {
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter132 : struct.references)
            {
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter133 : struct.containers)
            {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter134 : struct.attributes)
          {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter135 : struct.references)
          {
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter136 : struct.containers)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list137.size);
          AttributeSlot _elem138;
          for (int _i139 = 0; _i139 < _list137.size; ++_i139)
          {
            _elem138 = new AttributeSlot();
            _elem138.read(iprot);
            struct.attributes.add(_elem138);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list140.size);
          ReferenceSlot _elem141;
          for (int _i142 = 0; _i142 < _list140.size; ++_i142)
          {
            _elem141 = new ReferenceSlot();
            _elem141.read(iprot);
            struct.references.add(_elem141);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list143.size);
          ContainerSlot _elem144;
          for (int _i145 = 0; _i145 < _list143.size; ++_i145)
          {
            _elem144 = new ContainerSlot();
            _elem144.read(iprot);
            struct.containers.add(_elem144);
          }
        }
        struct.setContainersIsSet(true);
      }
