            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list104.size);
                AttributeSlot _elem105;
                for (int _i106 = 0; _i106 < _list104.size; ++_i106)
                {
                  _elem105 = new AttributeSlot();
                  _elem105.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list107.size);
                ReferenceSlot _elem108;
                for (int _i109 = 0; _i109 < _list107.size; ++_i109)
                {
                  _elem108 = new ReferenceSlot();
                  _elem108.read(iprot);
                  struct.references.add(_elem108);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list110.size);
                ContainerSlot _elem111;
                for (int _i112 = 0; _i112 < _list110.size; ++_i112)
                {
                  _elem111 = new ContainerSlot();
                  _elem111.read(iprot);
                  struct.containers.add(_elem111);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter113 : struct.attributes)
            {
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter114 : struct.references)
            {
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter115 : struct.containers)
            {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter116 : struct.attributes)
          {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter117 : struct.references)
          {
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter118 : struct.containers)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list119.size);
          AttributeSlot _elem120;
          for (int _i121 = 0; _i121 < _list119.size; ++_i121)
          {
            _elem120 = new AttributeSlot();
            _elem120.read(iprot);
            struct.attributes.add(_elem120);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list122.size);
          ReferenceSlot _elem123;
          for (int _i124 = 0; _i124 < _list122.size; ++_i124)
          {
            _elem123 = new ReferenceSlot();
            _elem123.read(iprot);
            struct.references.add(_elem123);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list125.size);
          ContainerSlot _elem126;
          for (int _i127 = 0; _i127 < _list125.size; ++_i127)
          {
            _elem126 = new ContainerSlot();
            _elem126.read(iprot);
            struct.containers.add(_elem126);
          }
        }
        struct.setContainersIsSet(true);
      }
