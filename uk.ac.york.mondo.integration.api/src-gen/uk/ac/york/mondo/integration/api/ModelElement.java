            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list112.size);
                AttributeSlot _elem113;
                for (int _i114 = 0; _i114 < _list112.size; ++_i114)
                {
                  _elem113 = new AttributeSlot();
                  _elem113.read(iprot);
                  struct.attributes.add(_elem113);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list115.size);
                ReferenceSlot _elem116;
                for (int _i117 = 0; _i117 < _list115.size; ++_i117)
                {
                  _elem116 = new ReferenceSlot();
                  _elem116.read(iprot);
                  struct.references.add(_elem116);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list118.size);
                ContainerSlot _elem119;
                for (int _i120 = 0; _i120 < _list118.size; ++_i120)
                {
                  _elem119 = new ContainerSlot();
                  _elem119.read(iprot);
                  struct.containers.add(_elem119);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter121 : struct.attributes)
            {
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter122 : struct.references)
            {
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter123 : struct.containers)
            {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter124 : struct.attributes)
          {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter125 : struct.references)
          {
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter126 : struct.containers)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list127.size);
          AttributeSlot _elem128;
          for (int _i129 = 0; _i129 < _list127.size; ++_i129)
          {
            _elem128 = new AttributeSlot();
            _elem128.read(iprot);
            struct.attributes.add(_elem128);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list130.size);
          ReferenceSlot _elem131;
          for (int _i132 = 0; _i132 < _list130.size; ++_i132)
          {
            _elem131 = new ReferenceSlot();
            _elem131.read(iprot);
            struct.references.add(_elem131);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list133.size);
          ContainerSlot _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new ContainerSlot();
            _elem134.read(iprot);
            struct.containers.add(_elem134);
          }
        }
        struct.setContainersIsSet(true);
      }
