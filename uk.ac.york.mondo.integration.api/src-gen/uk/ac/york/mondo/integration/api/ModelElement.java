            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.attributes = new ArrayList<AttributeSlot>(_list132.size);
                AttributeSlot _elem133;
                for (int _i134 = 0; _i134 < _list132.size; ++_i134)
                {
                  _elem133 = new AttributeSlot();
                  _elem133.read(iprot);
                  struct.attributes.add(_elem133);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.references = new ArrayList<ReferenceSlot>(_list135.size);
                ReferenceSlot _elem136;
                for (int _i137 = 0; _i137 < _list135.size; ++_i137)
                {
                  _elem136 = new ReferenceSlot();
                  _elem136.read(iprot);
                  struct.references.add(_elem136);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.containers = new ArrayList<ContainerSlot>(_list138.size);
                ContainerSlot _elem139;
                for (int _i140 = 0; _i140 < _list138.size; ++_i140)
                {
                  _elem139 = new ContainerSlot();
                  _elem139.read(iprot);
                  struct.containers.add(_elem139);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.attributes != null) {
        if (struct.isSetAttributes()) {
          oprot.writeFieldBegin(ATTRIBUTES_FIELD_DESC);
          {
            ...
            for (AttributeSlot _iter141 : struct.attributes)
            {
      ...
      if (struct.references != null) {
        if (struct.isSetReferences()) {
          oprot.writeFieldBegin(REFERENCES_FIELD_DESC);
          {
            ...
            for (ReferenceSlot _iter142 : struct.references)
            {
      ...
      if (struct.containers != null) {
        if (struct.isSetContainers()) {
          oprot.writeFieldBegin(CONTAINERS_FIELD_DESC);
          {
            ...
            for (ContainerSlot _iter143 : struct.containers)
            {
      ...
      if (struct.isSetAttributes()) {
        {
          ...
          for (AttributeSlot _iter144 : struct.attributes)
          {
      ...
      if (struct.isSetReferences()) {
        {
          ...
          for (ReferenceSlot _iter145 : struct.references)
          {
      ...
      if (struct.isSetContainers()) {
        {
          ...
          for (ContainerSlot _iter146 : struct.containers)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.attributes = new ArrayList<AttributeSlot>(_list147.size);
          AttributeSlot _elem148;
          for (int _i149 = 0; _i149 < _list147.size; ++_i149)
          {
            _elem148 = new AttributeSlot();
            _elem148.read(iprot);
            struct.attributes.add(_elem148);
          }
        }
        struct.setAttributesIsSet(true);
      }
      if (incoming.get(6)) {
        {
          ...
          struct.references = new ArrayList<ReferenceSlot>(_list150.size);
          ReferenceSlot _elem151;
          for (int _i152 = 0; _i152 < _list150.size; ++_i152)
          {
            _elem151 = new ReferenceSlot();
            _elem151.read(iprot);
            struct.references.add(_elem151);
          }
        }
        struct.setReferencesIsSet(true);
      }
      if (incoming.get(7)) {
        {
          ...
          struct.containers = new ArrayList<ContainerSlot>(_list153.size);
          ContainerSlot _elem154;
          for (int _i155 = 0; _i155 < _list153.size; ++_i155)
          {
            _elem154 = new ContainerSlot();
            _elem154.read(iprot);
            struct.containers.add(_elem154);
          }
        }
        struct.setContainersIsSet(true);
      }
