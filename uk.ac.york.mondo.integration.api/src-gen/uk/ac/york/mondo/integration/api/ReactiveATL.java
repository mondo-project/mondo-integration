              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.source = new ArrayList<ModelSpec>(_list288.size);
                  ModelSpec _elem289;
                  for (int _i290 = 0; _i290 < _list288.size; ++_i290)
                  {
                    _elem289 = new ModelSpec();
                    _elem289.read(iprot);
                    struct.source.add(_elem289);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.target = new ArrayList<ModelSpec>(_list291.size);
                  ModelSpec _elem292;
                  for (int _i293 = 0; _i293 < _list291.size; ++_i293)
                  {
                    _elem292 = new ModelSpec();
                    _elem292.read(iprot);
                    struct.target.add(_elem292);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, launch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.source != null) {
          oprot.writeFieldBegin(SOURCE_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter294 : struct.source)
            {
        ...
        if (struct.target != null) {
          oprot.writeFieldBegin(TARGET_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter295 : struct.target)
            {
    ...
    private static class launch_argsTupleScheme extends TupleScheme<launch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.transformation);
        {
          ...
          for (ModelSpec _iter296 : struct.source)
          {
        ...
        }
        {
          ...
          for (ModelSpec _iter297 : struct.target)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        struct.setTransformationIsSet(true);
        {
          ...
          struct.source = new ArrayList<ModelSpec>(_list298.size);
          ModelSpec _elem299;
          for (int _i300 = 0; _i300 < _list298.size; ++_i300)
          {
            _elem299 = new ModelSpec();
            _elem299.read(iprot);
            struct.source.add(_elem299);
          }
        }
        struct.setSourceIsSet(true);
        {
          ...
          struct.target = new ArrayList<ModelSpec>(_list301.size);
          ModelSpec _elem302;
          for (int _i303 = 0; _i303 < _list301.size; ++_i303)
          {
            _elem302 = new ModelSpec();
            _elem302.read(iprot);
            struct.target.add(_elem302);
          }
        }
        struct.setTargetIsSet(true);
      }
