              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.source = new ArrayList<ModelSpec>(_list248.size);
                  ModelSpec _elem249;
                  for (int _i250 = 0; _i250 < _list248.size; ++_i250)
                  {
                    _elem249 = new ModelSpec();
                    _elem249.read(iprot);
                    struct.source.add(_elem249);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.target = new ArrayList<ModelSpec>(_list251.size);
                  ModelSpec _elem252;
                  for (int _i253 = 0; _i253 < _list251.size; ++_i253)
                  {
                    _elem252 = new ModelSpec();
                    _elem252.read(iprot);
                    struct.target.add(_elem252);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, launch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.source != null) {
          oprot.writeFieldBegin(SOURCE_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter254 : struct.source)
            {
        ...
        if (struct.target != null) {
          oprot.writeFieldBegin(TARGET_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter255 : struct.target)
            {
    ...
    private static class launch_argsTupleScheme extends TupleScheme<launch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.transformation);
        {
          ...
          for (ModelSpec _iter256 : struct.source)
          {
        ...
        }
        {
          ...
          for (ModelSpec _iter257 : struct.target)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        struct.setTransformationIsSet(true);
        {
          ...
          struct.source = new ArrayList<ModelSpec>(_list258.size);
          ModelSpec _elem259;
          for (int _i260 = 0; _i260 < _list258.size; ++_i260)
          {
            _elem259 = new ModelSpec();
            _elem259.read(iprot);
            struct.source.add(_elem259);
          }
        }
        struct.setSourceIsSet(true);
        {
          ...
          struct.target = new ArrayList<ModelSpec>(_list261.size);
          ModelSpec _elem262;
          for (int _i263 = 0; _i263 < _list261.size; ++_i263)
          {
            _elem262 = new ModelSpec();
            _elem262.read(iprot);
            struct.target.add(_elem262);
          }
        }
        struct.setTargetIsSet(true);
      }
