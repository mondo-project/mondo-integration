              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.source = new ArrayList<ModelSpec>(_list312.size);
                  ModelSpec _elem313;
                  for (int _i314 = 0; _i314 < _list312.size; ++_i314)
                  {
                    _elem313 = new ModelSpec();
                    _elem313.read(iprot);
                    struct.source.add(_elem313);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.target = new ArrayList<ModelSpec>(_list315.size);
                  ModelSpec _elem316;
                  for (int _i317 = 0; _i317 < _list315.size; ++_i317)
                  {
                    _elem316 = new ModelSpec();
                    _elem316.read(iprot);
                    struct.target.add(_elem316);
                  }
                  iprot.readListEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, launch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.source != null) {
          oprot.writeFieldBegin(SOURCE_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter318 : struct.source)
            {
        ...
        if (struct.target != null) {
          oprot.writeFieldBegin(TARGET_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter319 : struct.target)
            {
    ...
    private static class launch_argsTupleScheme extends TupleScheme<launch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.transformation);
        {
          ...
          for (ModelSpec _iter320 : struct.source)
          {
        ...
        }
        {
          ...
          for (ModelSpec _iter321 : struct.target)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        struct.setTransformationIsSet(true);
        {
          ...
          struct.source = new ArrayList<ModelSpec>(_list322.size);
          ModelSpec _elem323;
          for (int _i324 = 0; _i324 < _list322.size; ++_i324)
          {
            _elem323 = new ModelSpec();
            _elem323.read(iprot);
            struct.source.add(_elem323);
          }
        }
        struct.setSourceIsSet(true);
        {
          ...
          struct.target = new ArrayList<ModelSpec>(_list325.size);
          ModelSpec _elem326;
          for (int _i327 = 0; _i327 < _list325.size; ++_i327)
          {
            _elem326 = new ModelSpec();
            _elem326.read(iprot);
            struct.target.add(_elem326);
          }
        }
        struct.setTargetIsSet(true);
      }
