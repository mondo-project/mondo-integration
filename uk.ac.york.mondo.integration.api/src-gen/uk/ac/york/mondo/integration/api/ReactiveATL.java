              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.source = new ArrayList<ModelSpec>(_list216.size);
                  ModelSpec _elem217;
                  for (int _i218 = 0; _i218 < _list216.size; ++_i218)
                  {
                    _elem217 = new ModelSpec();
                    _elem217.read(iprot);
                    struct.source.add(_elem217);
                  }
                  iprot.readListEnd();
                }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.target = new ArrayList<ModelSpec>(_list219.size);
                  ModelSpec _elem220;
                  for (int _i221 = 0; _i221 < _list219.size; ++_i221)
                  {
                    _elem220 = new ModelSpec();
                    _elem220.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, launch_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.source != null) {
          oprot.writeFieldBegin(SOURCE_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter222 : struct.source)
            {
        ...
        if (struct.target != null) {
          oprot.writeFieldBegin(TARGET_FIELD_DESC);
          {
            ...
            for (ModelSpec _iter223 : struct.target)
            {
    ...
    private static class launch_argsTupleScheme extends TupleScheme<launch_args> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        oprot.writeString(struct.transformation);
        {
          ...
          for (ModelSpec _iter224 : struct.source)
          {
        ...
        }
        {
          ...
          for (ModelSpec _iter225 : struct.target)
          {
      ...
      public void read(org.apache.thrift.protocol.TProtocol prot, launch_args struct) throws org.apache.thrift.TException {
        ...
        struct.setTransformationIsSet(true);
        {
          ...
          struct.source = new ArrayList<ModelSpec>(_list226.size);
          ModelSpec _elem227;
          for (int _i228 = 0; _i228 < _list226.size; ++_i228)
          {
            _elem227 = new ModelSpec();
            _elem227.read(iprot);
            struct.source.add(_elem227);
          }
        }
        struct.setSourceIsSet(true);
        {
          ...
          struct.target = new ArrayList<ModelSpec>(_list229.size);
          ModelSpec _elem230;
          for (int _i231 = 0; _i231 < _list229.size; ++_i231)
          {
            _elem230 = new ModelSpec();
            _elem230.read(iprot);
            struct.target.add(_elem230);
          }
        }
        struct.setTargetIsSet(true);
      }
