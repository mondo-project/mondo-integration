...
public class EffectiveMetamodelFormPage extends FormPage {
	...
	protected void createFormContent(IManagedForm managedForm) {
		...
		treeViewer = new ContainerCheckedTreeViewer(cTable);
		treeViewer.setContentProvider(new MetamodelContentProvider());
		treeViewer.setLabelProvider(new MetamodelLabelProvider());
		treeViewer.setCheckStateProvider(new MetamodelCheckStateProvider());
